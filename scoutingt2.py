        ...
        ui.layout_sidebar(
            ui.sidebar(
                ui.panel_well(
                    ...
                    ui.input_numeric("filtro_edad_min", "Edad Mínima", min=1998, max=2012, value=1998),
                    ui.input_numeric("filtro_edad_max", "Edad Máxima", min=1999, max=2012, value=2012),
            ...
            ui.panel_well(
                ui.layout_columns(
                    ...
                    ui.input_selectize("nuevo_pie", "Pie", choices=["Right", "Left", "Ambidiestro"], remove_button=True),
...
def server(input, output, session):
    ...
    @reactive.poll(cargar_historial,interval_secs=35)
    ...
    @reactive.effect
    @reactive.poll(lambda: cargar_datos()[1], interval_secs=25) 
    ...
    def agregar_nuevo_jugador():
        ...
        try:
            ...
            ui.notification_show(
                ...
                # Actualizar las opciones del menú desplegable de jugadores en la pestaña de detalles
            jugadores_actualizados = df_reactivo()["full_name"].unique().tolist()
            ui.update_selectize("jugador_detalle", choices=jugadores_actualizados)
    ...
    def descargar_historial():
        ...
        return file_path
    @reactive.effect
    def actualizar_choices_jugador():
        jugadores_unicos = sorted(df_reactivo()["full_name"].dropna().unique().tolist())
        ui.update_selectize("jugador_detalle", choices=jugadores_unicos)
    ...
    def detalle_jugador():
        ...
        info_personal = {
            "Nombre": jugador,
            "Año de Nacimiento": str(jugador_data.get("Birthdate", "Desconocido"))[:4],
